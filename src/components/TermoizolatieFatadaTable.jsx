...
import { termoizolatieFatadaData } from "./table-data";

const TermoizolatieFatadaTable = () => {
  return (
    <Table>
      ...
      <TableBody>
        {termoizolatieFatadaData.map((service, index) => (
          <TableRow key={index}>
...
export default TermoizolatieFatadaTable;
