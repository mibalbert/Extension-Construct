...
import { lucrariDeGipsCartonData } from "./table-data";

const LucrariDeGipsCartonTable = () => {
  return (
    <Table>
      ...
      <TableBody>
        {lucrariDeGipsCartonData.map((service, index) => (
          <TableRow key={index}>
...
export default LucrariDeGipsCartonTable;
