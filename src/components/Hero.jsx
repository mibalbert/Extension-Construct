...
const Hero = () => {
  return (
    <section
      id="home"
      className="overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36 bg-[url('/hero-img.webp')] bg-cover bg-center"
    >
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20 ">
          ...
          <div className="relative z-10 mx-auto  lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <Title
              ...
              className="text-7xl w-full lg:whitespace-nowrap font-bold text-black font-serif "
            />
            <Title
              title="Invest at the perfect time."
              className="text-4xl max-w-2xl"
            />
          ...
          <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
            <BackgroundDesign className="absolute left-1/4 top-4 h-[1026px] w-[1026px] -translate-x-1/4 stroke-gray-300/70 [mask-image:linear-gradient(to_bottom,white_20%,transparent_75%)] sm:top-16 sm:-translate-x-1/2 lg:-top-16 lg:ml-12 xl:-top-14 xl:ml-0" />
