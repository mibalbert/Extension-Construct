...
import { placariGresieSiFainata } from "./table-data";

const PlacariGresieSiFainataTable = () => {
  return (
    <Table>
      ...
      <TableBody>
        {placariGresieSiFainata.map((service, index) => (
          <TableRow key={index}>
...
export default PlacariGresieSiFainataTable;
