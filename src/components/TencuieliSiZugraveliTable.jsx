...
import { tencuieliSiZugraveliData } from "./table-data";

const TencuieliSiZugraveltTable = () => {
  return (
    <Table>
      ...
      <TableBody>
        {tencuieliSiZugraveliData.map((service, index) => (
          <TableRow key={index}>
...
export default TencuieliSiZugraveltTable;
